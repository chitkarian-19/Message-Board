      ...
      <input id="email" type="text" class="form-control" name="mail" placeholder="Email">
								...
								<div class="row">
                                   ...
                                   <div class="row">
                                        ...
                                        <div class="col-75">
<div class="input-group">
<span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span> <input type="password" class="form-control" minlength="8" id="pwd" name="password">
</div>
<br>
...
<br>
  <div class="w3-card" style="width:40px;height:60px;">
    <img src="user.png"></div><br>
    
    <a href="user.php"><button type="button" class="btn btn-warning">See Profile</button></a></div>
...
<img src="i9.png" class="w3-image w3-greyscale-min" style="width:100%">
